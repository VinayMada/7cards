...
.opp-chip{background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.08);border-radius:10px;padding:6px 10px;min-width:90px;flex-shrink:0;transition:all 0.2s;}
.opp-chip-active{background:rgba(212,168,67,0.12);border-color:var(--gold);box-shadow:0 0 10px rgba(212,168,67,0.15);}
...
.score-chip{display:flex;align-items:center;gap:5px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.07);border-radius:16px;padding:3px 10px;font-size:11px;}
